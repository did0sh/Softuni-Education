...
public class PartServiceImpl implements PartService {
    ...
    @Override
    public void seedParts(PartsPartDto partsSeedDto) {
        for (PartSeedDto partSeedDto : partsSeedDto.getPartSeedDtos()) {
            ...
            Part entity = this.mapper.map(partSeedDto, Part.class);
