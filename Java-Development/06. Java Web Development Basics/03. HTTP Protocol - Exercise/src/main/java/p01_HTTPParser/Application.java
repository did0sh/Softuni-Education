package main.java.p01_HTTPParser;
...
public class Application {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (!validUrls.contains(url)){
            ...
            response.append(System.lineSeparator())
                    .append(String.format("Greetings %s! You have successfully created %s with %s, %s.",
    ...
    private static Map<String, String> getHeaders(List<String> request){
        ...
        request.stream().skip(1)
                ...
                .forEach(kvp -> headers.put(kvp[0], kvp[1]));
    ...
    private static Map<String, String> getBodyParams(List<String> request){
        ...
        Arrays.stream(request.get(request.size() - 1).split("&"))
                ...
                .forEach(bp -> bodyParams.put(bp[0], bp[1]));
