...
public class CatProfileServlet extends HttpServlet {
    ...
    private static final String CAT_PROFILE_HTML_FILE_PATH =
            "C:\\Users\\user\\IdeaProjects\\07. Java Web Development Basics\\05. JavaEE - Exercise\\src\\main\\resources\\views\\cat-profile.html";
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (cat == null){
             htmlFileContent =
                    this.htmlReader.readHtmlFile("C:\\Users\\user\\IdeaProjects\\07. Java Web Development Basics\\05. JavaEE - Exercise\\src\\main\\resources\\views\\non-existent-cat.html")
                    .replace("{{catName}}", req.getQueryString().split("=")[1]);

        } else {
             htmlFileContent
                    = this.htmlReader.readHtmlFile(CAT_PROFILE_HTML_FILE_PATH)
