...
public class IndexServlet extends HttpServlet {
    ...
    private final static String INDEX_HTML_FILE_PATH =
            "C:\\Users\\user\\IdeaProjects\\07. Java Web Development Basics\\06. JavaEE Servlets - Exercise\\src\\main\\resources\\views\\index.html";
    ...
    private String formatListItems(){
        ...
        allProducts.forEach(product ->
                listItems.append(String.format("<li><a href=\"/products/details?=%s\">%s</a></li>", product.getName(), product.getName()))
