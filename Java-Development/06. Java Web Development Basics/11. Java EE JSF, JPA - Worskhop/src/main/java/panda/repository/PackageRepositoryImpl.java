...
public class PackageRepositoryImpl implements PackageRepository {
    ...
    public List<Package> findAll() {
        ...
        List<Package> packages = this.entityManager
                .createQuery("SELECT p FROM packages p ", Package.class)
                .getResultList();
        this.entityManager.getTransaction().commit();
    ...
    public Package findById(String id) {
        ...
        Package aPackage = this.entityManager
                .createQuery("SELECT p FROM packages p WHERE p.id = :id", Package.class)
                .setParameter("id", id)
                .getSingleResult();
        this.entityManager.getTransaction().commit();
    ...
    public Long size() {
        ...
        Long size = this.entityManager
                .createQuery("SELECT count(p) FROM packages p ", Long.class)
                .getSingleResult();
        this.entityManager.getTransaction().commit();
