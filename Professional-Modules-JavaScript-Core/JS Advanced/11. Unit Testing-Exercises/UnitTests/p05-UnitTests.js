...
let sharedObject = require('../p05_SharedObject.js').sharedObject;

describe('sharedObj', function(){
    before(()=>global.$ = $);
   describe('starting variables', function(){
    ...
    describe("changeIncome function", function () {
        ...
        it("should return previous value after calling with floating parameter", function () {
            sharedObject.changeIncome(5);
            sharedObject.changeIncome(5.2);
            expect(sharedObject.income).to.equal(5);
            expect($('#income').val()).to.equal("5");
        });
    });
